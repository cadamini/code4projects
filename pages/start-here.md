...
My name is Salvatore D’Angelo and I am a professional software engineer working for a well-known American software company. You can read my story [here](about-me).
...
![Software Developer]({{ '/assets/img/software-developer.jpeg' | relative_url }}){:width="450" height="450" .responsive_img}
...
![Sharing Knowledge]({{ '/assets/img/sharing-knowledge.png' | relative_url }}){:width="235" height="215" .responsive_img}
...
![Make a project]({{ '/assets/img/make-project.png' | relative_url }}){:width="450" height="434" .responsive_img}
